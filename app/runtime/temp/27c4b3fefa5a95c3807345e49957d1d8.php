<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\WWW\ServerGit\app\public/../application/admin\view\login\index.html";i:1512130992;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <form class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="<?php echo captcha_src(); ?>" width="205" height="45" alt="" title="点击更换验证码" onclick="this.src='<?php echo captcha_src(); ?>'">
        </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
