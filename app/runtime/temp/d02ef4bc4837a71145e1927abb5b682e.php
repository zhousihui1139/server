<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\WWW\ServerGit\app\public/../application/admin\view\admin\add.html";i:1512110586;s:71:"E:\WWW\ServerGit\app\public/../application/admin\view\public\_meta.html";i:1512097298;s:73:"E:\WWW\ServerGit\app\public/../application/admin\view\public\_footer.html";i:1512095464;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="username" name="username" required="required">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>密码：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="password" class="input-text" autocomplete="off" value="" placeholder="" id="password" name="password"  required="required">
		</div>
	<!-- <div class="row cl">
