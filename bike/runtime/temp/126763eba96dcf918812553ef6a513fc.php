<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\WWW\project\tp5\bike\public/../application/admin\view\article\edit.html";i:1510565194;s:75:"E:\WWW\project\tp5\bike\public/../application/admin\view\public\header.html";i:1510383902;s:73:"E:\WWW\project\tp5\bike\public/../application/admin\view\public\left.html";i:1510312538;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        <li><a href="<?php echo url('admin/index/index'); ?>">系统</a></li>
...
<form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input class="form-control" required="true" placeholder="" name="title" type="text" value="<?php echo $art['title']; ?>">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input class="form-control" required="true"  placeholder="" name="author" type="text" value="<?php echo $art['author']; ?>">
        </div>
        <p class="help-block col-sm-4 red">* 必填</p>
    </div>

    <div class="form-group">
        <label for="username" class="col-sm-2 control-label no-padding-right">所属文章</label>
        <div class="col-sm-6">
            <select name="cateid">
                <?php if(is_array($cates) || $cates instanceof \think\Collection || $cates instanceof \think\Paginator): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <option value="<?php echo $vo['id']; ?>" <?php if($vo['id']==$art['cateid']): ?>selected='true'<?php endif; ?>><?php echo str_repeat('&nbsp;&nbsp;&nbsp;',$vo['level']); ?><?php echo $vo['catename']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
        <p class="help-block col-sm-4 red">* 必填</p>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <label  class="radio" style="float:left; margin-right:10px;" style="margin-right:15px;">
                <input <?php if($art['rec'] == 1): ?>checked="checked"<?php endif; ?>  name="rec" value="1" type="radio">
                <span class="text">是</span>
            </label>
            <label class="radio" style="float:left; margin-right:10px;" style="margin-right:15px;">
                <input <?php if($art['rec'] == 0): ?>checked="checked"<?php endif; ?>  class="inverted" name="rec" value="0" type="radio">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input class="form-control"  placeholder="" name="keywords" type="text" value="<?php echo $art['keywords']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <textarea name="desc" class="form-control"> <?php echo $art['desc']; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input placeholder="" name="thumb" type="file" style="float: left;">
            <div style="float: left;">
            <?php if($art['thumb']==''): ?>
                暂无缩略图
                <?php else: ?>
                <img width="100" height="60" src="PUBLIC/uploads/<?php echo $art['thumb']; ?>" >
            <?php endif; ?>
            </div>
        </div>
    </div>
