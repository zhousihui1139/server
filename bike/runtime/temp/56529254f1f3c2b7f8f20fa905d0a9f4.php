<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\WWW\project\tp5\bike\public/../application/admin\view\conf\showlist.html";i:1510129750;s:75:"E:\WWW\project\tp5\bike\public/../application/admin\view\public\header.html";i:1510383902;s:73:"E:\WWW\project\tp5\bike\public/../application/admin\view\public\left.html";i:1510312538;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>配置管理</title>
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="center" title="<?php echo $vo['values']; ?>">
                    <?php switch($vo['type']): case "1": ?>单行文本<?php break; case "2": ?>多行文本<?php break; case "3": ?>单选按钮<?php break; case "4": ?>复选按钮<?php break; case "5": ?>下拉菜单<?php break; default: ?><span style="color:red" >未知类型</span>
                    <?php endswitch; ?>
                </td>
                ...
                <td align="center">
                    ...
                    <a href="#" onClick="warning('删除时会删除本配置下所有子配置以及文章;确认删除吗?', '<?php echo url('del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
        ...
        <tr><td colspan="7" align="center"><input type="submit" value="排序" class="btn btn-primary btn-sm shiny"></td></tr>
    </table>
</form>
                </div>
