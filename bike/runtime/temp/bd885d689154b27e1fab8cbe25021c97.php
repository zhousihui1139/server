<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"E:\WWW\project\tp5\bike\public/../application/admin\view\auth_group\add.html";i:1510312572;s:75:"E:\WWW\project\tp5\bike\public/../application/admin\view\public\header.html";i:1509701424;s:73:"E:\WWW\project\tp5\bike\public/../application/admin\view\public\left.html";i:1510312538;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>管理员组</title>
    ...
    <tr>
        <td>
            <label>
                ...
                <input name="rules[]" value="<?php echo $vo['id']; ?>" subids="<?php echo $vo->getSubIds($vo['id']); ?>" supids="<?php echo $vo->getSupIds($vo['id']); ?>"   class="inverted checkbox-parent <?php if($vo['level'] !== 0): ?> checkbox-child <?php endif; ?> " type="checkbox">
