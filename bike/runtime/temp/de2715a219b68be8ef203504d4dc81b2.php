<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\WWW\project\tp5\bike\public/../application/admin\view\auth_rule\add.html";i:1510306562;s:75:"E:\WWW\project\tp5\bike\public/../application/admin\view\public\header.html";i:1509701424;s:73:"E:\WWW\project\tp5\bike\public/../application/admin\view\public\left.html";i:1510312538;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>权限</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                            ...
                            <div class="col-sm-6">
                                <select name="pid">
                                    ...
                                    <?php if(is_array($rules) || $rules instanceof \think\Collection || $rules instanceof \think\Paginator): $i = 0; $__LIST__ = $rules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo $vo['id']; ?>"><?php echo str_repeat('&nbsp;', $vo['level']*5); ?><?php echo $vo['title']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        ...
                        <div class="form-group" name='condition_text'>
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" placeholder="" name="condition" ></textarea>
                            </div>
                        </div>
